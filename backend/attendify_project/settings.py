...
SECRET_KEY = 'django-insecure-*^o-#3h9l(n-1k1&g=xw6f^z01z#d$nn85kur9t@2epb)2@8bs'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': (
        ...
        # Adjust permissions as needed per view later
    )
    # Add other DRF settings like pagination, throttling etc. later if required
}
...
SIMPLE_JWT = {
    ...
    "UPDATE_LAST_LOGIN": True, # Updates user's last_login field on refresh
